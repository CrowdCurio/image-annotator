...
ImageAnnotator.prototype.attachHandlers = function() {
    ...
    $('*').on("keydown", function(e) {
        var chat_box = document.getElementById("chat-input-box");
...
ImageAnnotator.prototype.render = function(config) {
    ...
    var modals = ['loading_modal', 'fetching_task_modal', 'finished_modal', 'practice_finished_modal', 'practice_information_modal', 'survey_efficacy_modal', 'experiment_complete_modal', 'tutorial_modal'];
   ...
   // move next carousel
   $('.tutorial-btn-next').click(function(e){
    e.preventDefault();
    e.stopPropagation();
    ...
    // move prev carousel
    $('.tutorial-btn-prev').click(function(e){
        e.preventDefault();
        e.stopPropagation();
        $('.carousel').carousel('prev');
     });

     $(".tutorial-btn-close").click(function(e){
        e.preventDefault();
        e.stopPropagation();
